...
class MainActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    val PREFS_FILENAME = "com.banticsoftware.mainapp.mainapp.prefs"
    val USERNAME =""
    val PASSWORD =""
    val SAVELOGIN = 0
    val INICIO = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        deviceID = "MA-"+deviceID.toString().toUpperCase()
    ...
    private fun attemptLogin() {
       ...
       /* if (!TextUtils.isEmpty(passwordStr) && !isPasswordValid(passwordStr)) {
        ...
        if (cancel) {
            ...
            var URL ="https://mainapp.kaizenpro.co.uk/marcador_login_client.php?em="+device+"&pw="+passwordStr
                ...
                result.success {
                    ...
                    if(Users.isNotEmpty()) {
                        ...
                        if (Users[0].rol.toInt()!=2){
                            ...
                            intent.putExtra("Sexo", Users[0].sexo)
                            intent.putExtra("Edad", Users[0].edad)
                            intent.putExtra("Direccion", Users[0].direccion)
                            startActivity(intent)
                        }
                    }else{
                        //password.error = getString(R.string.error_incorrect_password)
                        mPinLockView.resetPinLockView()
                        //indicator_dots.requestFocus()
